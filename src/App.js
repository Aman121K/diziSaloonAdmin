    ...
    const menu = [
        {
            ...
            items: [
                ...
                { label: "Styles", icon: "pi pi-fw pi-book", to: "/styles" },
                { label: "Ads", icon: "pi pi-fw pi-book", to: "/ads" },
                { label: "Articals", icon: "pi pi-fw pi-book", to: "/articals" },
                ...
                { label: "FeedBack", icon: "pi pi-fw pi-check-square", to: "/feedback" },
            ],
        },
        // {
        //     label: "UI Components",
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <div className="layout-main-container">
                <div className="layout-main">
                    <ProtectedRoute />
                    {/* <Route path="*" name="Dashboard" element={<ProtectedRoute />} /> */}
